...
\newcommand{\lnum}[1]{%
  \@ifundefined{r@#1}%
    {\textcolor{red}{\textbf{[line ??\ -- rebuild manuscript\_annotated.tex]}}}%
    {line~\ref{#1}}}
\makeatother
...
% scripts/new_revision.py replaces the marker below with the title, authors and
% affiliations copied out of the manuscript, so they are not typed twice. Correct
% them here if they change after this letter was created.
%%PAPER-METADATA%%
