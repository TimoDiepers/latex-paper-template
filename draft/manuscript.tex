% Pre-submission draft, for internal review only.
% This is the only version that carries the target journal, the reviewer
% suggestions and the table of contents. Everything from rev0/ onwards is
% journal-facing and drops them.
...
Set up the case or dataset first, then report what it produced. Quantify: state
